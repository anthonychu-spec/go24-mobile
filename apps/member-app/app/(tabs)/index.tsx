  ...
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.c}>
        ...
        <Pressable style={s.cardBtn} onPress={() => router.push('/payment/update-card')}>
          <Text style={s.cardBtnText}>💳  Update Credit Card</Text>
        </Pressable>
...
const s = StyleSheet.create({
  ...
  cardBtnText: { color: colors.bg, fontWeight: '700', fontSize: 15 },
  btn: { marginTop: 12, paddingHorizontal: 24, paddingVertical: 12, borderWidth: 1, borderColor: colors.border, borderRadius: 8 },
